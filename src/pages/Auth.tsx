...
export default function Auth() {
  ...
  async function resendConfirmation() {
    toast.info("Email confirmation isn't required for local accounts.");
  }
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-200 to-blue-100 dark:from-slate-900 dark:to-slate-800">
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-200 to-blue-100 dark:from-slate-900 dark:to-slate-800 weather-pattern">
      <Card className="w-full max-w-md glass-card animate-fade-in">
        <CardHeader className="space-y-1 flex flex-col items-center">
          <Logo />
          <CardTitle className="text-2xl mt-4">Welcome to SkyCast</CardTitle>
